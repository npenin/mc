...
route.on('music/tracks', function(){
	...
	$('.music #libraryTracks').DataTable({
		...
		columns: [
			...
			{ title:"Commands", data:"id", createdCell:function(cell,cellData,rowData, rowIndex,colIndex){
				$(cell).empty().addClass('navbar-inverse')
					.append($('<a class="pull-left" href="#music/tracks"><span class="icon-32 icon-play-32"></span></a>').click(function(){
						commands.play(cellData);
					}))
					.append($('<a class="pull-left" href="#music/tracks"><span class="icon-32 icon-back-32"></span></a>').click(function(){
